...
_G.ThongBao = "cam on ban da dung script"
_G.ThongBaoChoose = "buituanandzzz"

_G.Discord = "https://discord.com/api/guilds/1291288392503656469/widget.json"
notis = require(game.ReplicatedStorage:WaitForChild("Notification"))
notis.new("<Color=Pink>GG \n<Color=/>".. _G.ThongBao):Display()
_G.SafeFarm = true
...
print("Made By: buituanandzzz
")
warn("skibiti toilet")
warn("Deobf Lafmm Gif:3")
print("Anh Yewu Be Ma Cu Dms Xin La Anh Cho:33")
...
ttittles.Text = "buituanandzzz hub"
